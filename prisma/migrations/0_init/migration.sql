...
CREATE TABLE `aerodromes` (
    ...
    `has_taf` BOOLEAN NOT NULL DEFAULT false,
    `has_metar` BOOLEAN NOT NULL DEFAULT false,
    `has_fds` BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE `arrivals` (
    ...
    `temperature_c` INTEGER NOT NULL DEFAULT 15,
    `wind_direction` INTEGER NULL,
    `wind_magnitude_knot` INTEGER NOT NULL DEFAULT 0,
    `altimeter_inhg` DECIMAL(4, 2) NOT NULL DEFAULT 29.92,
...
CREATE TABLE `baggages` (
    ...
    `weight_lb` DECIMAL(5, 2) NOT NULL DEFAULT 5.0,
    `flight_id` INTEGER NOT NULL,
...
CREATE TABLE `flight_waypoints` (
    ...
    `name` VARCHAR(50) NOT NULL,
    `from_user_waypoint` BOOLEAN NOT NULL DEFAULT false,
    `from_vfr_waypoint` BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE `flights` (
    ...
    `bhp_percent` INTEGER NOT NULL DEFAULT 65,
    `added_enroute_time_hours` DECIMAL(4, 2) NOT NULL DEFAULT 0.0,
    `reserve_fuel_hours` DECIMAL(4, 2) NOT NULL DEFAULT 0.5,
    `contingency_fuel_hours` DECIMAL(4, 2) NOT NULL DEFAULT 0.0,
    `briefing_radius_nm` INTEGER NOT NULL DEFAULT 10,
    `alternate_radius_nm` INTEGER NOT NULL DEFAULT 25,
...
CREATE TABLE `fuel` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `gallons` DECIMAL(5, 2) NOT NULL DEFAULT 0.0,
    `flight_id` INTEGER NOT NULL,
...
CREATE TABLE `fuel_tanks` (
    ...
    `unusable_fuel_gallons` DECIMAL(5, 2) NOT NULL DEFAULT 0.0,
    `burn_sequence` INTEGER NOT NULL DEFAULT 1,
    `performance_profile_id` INTEGER NOT NULL,
    `created_at` DATETIME(0) NOT NULL,
    `last_updated` DATETIME(0) NOT NULL,
...
CREATE TABLE `legs` (
    ...
    `altitude_ft` INTEGER NOT NULL DEFAULT 2000,
    `temperature_c` INTEGER NOT NULL DEFAULT 13,
    `wind_direction` INTEGER NULL,
    `wind_magnitude_knot` INTEGER NOT NULL DEFAULT 0,
    `altimeter_inhg` DECIMAL(4, 2) NOT NULL DEFAULT 29.92,
    `temperature_last_updated` DATETIME(0) NULL,
...
CREATE TABLE `passenger_profiles` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(255) NOT NULL,
    `weight_lb` DECIMAL(5, 2) NOT NULL DEFAULT 200.0,
...
CREATE TABLE `performance_profiles` (
    ...
    `empty_weight_lb` DECIMAL(7, 2) NOT NULL DEFAULT 0.0,
    `max_ramp_weight_lb` DECIMAL(7, 2) NOT NULL DEFAULT 0.0,
    `max_takeoff_weight_lb` DECIMAL(7, 2) NOT NULL DEFAULT 0.0,
    `max_landing_weight_lb` DECIMAL(7, 2) NOT NULL DEFAULT 0.0,
    `baggage_allowance_lb` DECIMAL(6, 2) NOT NULL DEFAULT 0.0,
    `take_off_taxi_fuel_gallons` DECIMAL(4, 2) NOT NULL DEFAULT 0.0,
    `percent_decrease_takeoff_headwind_knot` DECIMAL(4, 2) NOT NULL DEFAULT 0.0,
    `percent_increase_takeoff_tailwind_knot` DECIMAL(4, 2) NOT NULL DEFAULT 0.0,
    `percent_decrease_landing_headwind_knot` DECIMAL(4, 2) NOT NULL DEFAULT 0.0,
    `percent_increase_landing_tailwind_knot` DECIMAL(4, 2) NOT NULL DEFAULT 0.0,
    `percent_increase_climb_temperature_c` DECIMAL(4, 2) NOT NULL DEFAULT 0.0,
...
CREATE TABLE `surfaces_performance_decrease` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `percent` DECIMAL(4, 2) NOT NULL DEFAULT 0,
    `is_takeoff` BOOLEAN NOT NULL DEFAULT true,
    `surface_id` INTEGER NOT NULL,
    `performance_profile_id` INTEGER NOT NULL,
    `created_at` DATETIME(0) NOT NULL,
    `last_updated` DATETIME(0) NOT NULL,
...
CREATE TABLE `waypoints` (
    ...
    `lat_minutes` INTEGER NOT NULL DEFAULT 0,
    `lat_seconds` INTEGER NOT NULL DEFAULT 0,
    `lat_direction` VARCHAR(1) NOT NULL DEFAULT 'N',
    `lon_degrees` INTEGER NOT NULL,
    `lon_minutes` INTEGER NOT NULL DEFAULT 0,
    `lon_seconds` INTEGER NOT NULL DEFAULT 0,
    `lon_direction` VARCHAR(1) NOT NULL DEFAULT 'E',
...
CREATE TABLE `weight_balance_profiles` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(50) NOT NULL DEFAULT 'Normal Category',
    `performance_profile_id` INTEGER NOT NULL,
    `created_at` DATETIME(0) NOT NULL,
    `last_updated` DATETIME(0) NOT NULL,
